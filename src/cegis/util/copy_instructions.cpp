...
// LSH FIXME!!
void synth_remove_skips(goto_programt::instructionst &instrs)
{
  danger_remove_skips(instrs);
}

void synth_make_presentable(goto_programt::instructionst &instrs)
{
  danger_make_presentable(instrs);
}
