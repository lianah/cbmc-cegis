...
const char LAST_PREFIX[]="__CPROVER_synth_opcode_last_";
const char SINGLE_PREFIX[]="__CPROVER_synth_opcode_";
...
void Synth::extract_instruction_set(instruction_sett &instruction_set,
    const goto_functionst &gf)
{
  typedef goto_functionst::function_mapt function_mapt;
  const function_mapt &function_map=gf.function_map;
  const function_mapt::const_iterator it=function_map.find(SYNTH_EXECUTE);
