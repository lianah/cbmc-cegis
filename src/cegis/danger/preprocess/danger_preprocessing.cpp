...
Danger::danger_preprocessingt::danger_preprocessingt(const symbol_tablet &st,
    const goto_functionst &gf, constant_strategyt constant_strategy) :
    original_program(st, gf), constant_strategy(constant_strategy)
{
}

Danger::danger_preprocessingt::~danger_preprocessingt()
{
}
...
size_t Danger::danger_preprocessingt::get_min_solution_size() const
{
...
void Danger::danger_preprocessingt::operator ()()
{
...
void Danger::danger_preprocessingt::operator ()(const size_t max_length)
{
  current_program=original_program;
...
const danger_programt &Danger::danger_preprocessingt::get_danger_program() const
{
