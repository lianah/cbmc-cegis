...
std::string Danger::get_Dx(const size_t loop_id)
{
...
std::string Danger::get_Gx(const size_t loop_id)
{
...
std::string Danger::get_Dx_prime(const size_t loop_id)
{
...
std::string Danger::get_Rx(const size_t loop_id, const size_t result_id)
{
  return build_var_name(RANKING_PREFIX, loop_id, STATE_BEFORE_LOOP, result_id);
}

std::string Danger::get_Rx_prime(const size_t loop_id, const size_t result_id)
{
...
std::string Danger::get_Sx(const size_t loop_id, const size_t result_id)
{
  return build_var_name(SKOLEM_PREFIX, loop_id, STATE_BEFORE_LOOP, result_id);
}

std::string Danger::get_tmp(const size_t id)
{
