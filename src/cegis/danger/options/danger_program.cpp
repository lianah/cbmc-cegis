...
Danger::danger_programt::danger_programt()
{
}

Danger::danger_programt::danger_programt(const symbol_tablet &st,
...
void Danger::danger_programt::set_goto_program(const symbol_tablet &st,
    const goto_functionst &gf)
{
  this->st=st;
  this->gf.clear();
...
public:
  ...
  Danger::danger_programt::meta_vars_positionst operator()(
      const Danger::danger_programt::meta_vars_positionst &vars) const
  {
    Danger::danger_programt::meta_vars_positionst result;
  ...
  Danger::danger_programt::program_ranget operator()(
      const Danger::danger_programt::program_ranget &range) const
  {
    Danger::danger_programt::program_ranget result;
    result.begin=fix(range.begin);
    result.end=fix(range.end);
    return result;
  }
  Danger::danger_programt::loopt operator()(const Danger::danger_programt::loopt &loop) const
  {
    Danger::danger_programt::loopt result;
...
danger_programt &assign(danger_programt &lhs, const danger_programt &rhs)
{
  ...
  const Danger::danger_programt::loopst &old_loops=rhs.loops;
...
Danger::danger_programt::danger_programt(const danger_programt &other) :
    st(other.st)
{
...
danger_programt &Danger::danger_programt::operator =(const danger_programt &other)
{
