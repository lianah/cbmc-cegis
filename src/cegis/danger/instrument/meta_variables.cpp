...
std::string Danger::get_danger_meta_name(const std::string &base_name)
{
...
goto_programt::targett Danger::declare_danger_variable(symbol_tablet &st,
...
symbolt &Danger::create_danger_symbol(symbol_tablet &st, const std::string &full_name,
    const typet &type)
{
  symbolt new_symbol;
...
goto_programt::targett Danger::danger_assign(const symbol_tablet &st,
...
goto_programt::targett Danger::danger_assign_user_variable(const symbol_tablet &st,
    goto_functionst &gf, const goto_programt::targett &insert_after_pos,
...
goto_programt::targett Danger::assign_danger_variable(const symbol_tablet &st,
    goto_functionst &gf, const goto_programt::targett &insert_after_pos,
...
typet Danger::danger_meta_type()
{
  return unsigned_int_type();
}

source_locationt Danger::default_danger_source_location()
{
