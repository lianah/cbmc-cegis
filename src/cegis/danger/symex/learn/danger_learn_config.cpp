...
Danger::danger_learn_configt::danger_learn_configt(const danger_programt &program) :
    original_program(program)
{
}

Danger::danger_learn_configt::~danger_learn_configt()
{
}

void Danger::danger_learn_configt::process(const counterexamplest &counterexamples,
...
const symbol_tablet &Danger::danger_learn_configt::get_symbol_table() const
{
  return program.st;
}

const goto_functionst &Danger::danger_learn_configt::get_goto_functions() const
{
  return program.gf;
}

void Danger::danger_learn_configt::danger_learn_configt::convert(candidatet &candidate,
...
void Danger::danger_learn_configt::show_candidate(messaget::mstreamt &os,
