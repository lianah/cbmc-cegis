...
void Danger::force_assertion_satisfaction(goto_functionst &gf, const size_t num_loops)
{
...
void Danger::force_invariant_and_guard_satisfaction(goto_functionst &gf,
