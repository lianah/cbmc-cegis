...
#define __CPROVER_synth_max_instruction 1u
#define __CPROVER_synth_commutative 1u
                              ...
                              unsigned char size)
{
  for (unsigned char i = 0; i < size; ++i)
  {
    ...
    __CPROVER_assume(synth_op0_id < synth_max_op_index &&
		     ...
		     // All operands cannot be constants
                     (synth_opcode < 1u || synth_op0_id <= synth_op1_id) &&
                     (synth_op2_id == 0)
  ...
  #define synth_sop1 ((int) op1)
   ...
   if (synth_opcode == 0) {
      ...
      __CPROVER_synth_opcode_1: result=synth_sop0 < synth_sop1;
   }
